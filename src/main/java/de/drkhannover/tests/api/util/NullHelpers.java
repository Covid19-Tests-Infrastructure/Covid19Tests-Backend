package de.drkhannover.tests.api.util;
 ...
 * tools are used. 
 * 
 * @author Adam - original author
 * @author Marcel - adjusted this class to fit into sparkyservice project
 */
public class NullHelpers {
     ...
     */
    @Nonnull
    public static final <T> T notNull(@Nullable T value, @Nullable String msg) throws AssertionError {
        if (value == null) {
     ...
     */
    @Nonnull
    public static final <T> T notNull(@Nullable T value) throws AssertionError {
        if (value == null) {
     ...
     */
    @Nullable
    public static final <T> T maybeNull(T value) {
        return value;
    }
